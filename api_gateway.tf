...
resource "aws_api_gateway_method" "options_user_search_method" {
  rest_api_id   = aws_api_gateway_rest_api.api.id
  resource_id   = aws_api_gateway_resource.user_search_resource.id
  http_method   = "OPTIONS"
  authorization = "NONE"
...
resource "aws_api_gateway_integration" "options_user_search_integration" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_search_resource.id
  http_method = aws_api_gateway_method.options_user_search_method.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_method_response" "get_user_method_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_id_resource.id
  http_method = aws_api_gateway_method.get_user_method.http_method
  status_code = "200"
...
resource "aws_api_gateway_method_response" "update_user_method_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_id_resource.id
  http_method = aws_api_gateway_method.update_user_method.http_method
  status_code = "200"
...
resource "aws_api_gateway_method_response" "list_users_method_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_search_resource.id
  http_method = aws_api_gateway_method.list_users_method.http_method
  status_code = "200"
...
resource "aws_api_gateway_method_response" "delete_user_method_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_id_resource.id
  http_method = aws_api_gateway_method.delete_user_method.http_method
  status_code = "200"
...
resource "aws_api_gateway_method_response" "options_user_search_method_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_search_resource.id
  http_method = aws_api_gateway_method.options_user_search_method.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "lambda_get_user_integration_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_id_resource.id
  http_method = aws_api_gateway_method.get_user_method.http_method
  status_code = "200"
  ...
  depends_on = [
    ...
    aws_api_gateway_method_response.get_user_method_response
  ]
}

resource "aws_api_gateway_integration_response" "lambda_create_user_integration_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_resource.id
  http_method = aws_api_gateway_method.create_user_method.http_method
  status_code = "200"
  ...
  depends_on = [
    ...
    aws_api_gateway_method_response.create_user_method_response
  ]
}

resource "aws_api_gateway_integration_response" "lambda_update_user_integration_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_id_resource.id
  http_method = aws_api_gateway_method.update_user_method.http_method
  status_code = "200"
  ...
  depends_on = [
    ...
    aws_api_gateway_method_response.update_user_method_response
  ]
}

resource "aws_api_gateway_integration_response" "lambda_list_users_integration_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_search_resource.id
  http_method = aws_api_gateway_method.list_users_method.http_method
  status_code = "200"
  ...
  depends_on = [
    ...
    aws_api_gateway_method_response.list_users_method_response
  ]
}

resource "aws_api_gateway_integration_response" "lambda_delete_user_integration_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.user_id_resource.id
  http_method = aws_api_gateway_method.delete_user_method.http_method
  status_code = "200"
  ...
  depends_on = [
    ...
    aws_api_gateway_method_response.delete_user_method_response
  ]
}
...
resource "aws_api_gateway_deployment" "api_deployment" {
  depends_on = [
    ...
    aws_api_gateway_method.options_user_search_method,
    aws_api_gateway_integration.lambda_get_user_integration,
    aws_api_gateway_integration.lambda_create_user_integration,
    aws_api_gateway_integration.lambda_update_user_integration,
    aws_api_gateway_integration.lambda_list_users_integration,
    ...
    aws_api_gateway_integration.options_user_search_integration,
    aws_api_gateway_integration_response.lambda_get_user_integration_response,
    aws_api_gateway_integration_response.lambda_create_user_integration_response,
    aws_api_gateway_integration_response.lambda_update_user_integration_response,
    aws_api_gateway_integration_response.lambda_list_users_integration_response,
    aws_api_gateway_integration_response.lambda_delete_user_integration_response
  ]
